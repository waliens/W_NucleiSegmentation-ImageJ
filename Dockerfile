...
RUN mv NucleiSegmentation-ImageJ.ijm /fiji/macros/NucleiSegmentation-ImageJ.ijm                                           
RUN mv run-segment-clustered-nuclei.sh /fiji/run-segment-clustered-nuclei.sh && chmod a+x /fiji/run-segment-clustered-nuclei.sh
